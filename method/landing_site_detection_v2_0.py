...
from method.utils.utils import  process_sg, process_so, find_safe_zones_mean_magnitude_v2
import os

class ImageProcessor:
    def __init__(self, class_scores, class_mapping, image_path, tile_size_sg, step_size_sg, tile_size_of):
    ...
    def find_safe_zones_mean_magnitude_v2(self, flow):
        return find_safe_zones_mean_magnitude_v2(flow,  self.tile_size_of)
    ...
    def process_images(self, flow_result, segmentation_result):
        ...
        so = find_safe_zones_mean_magnitude_v2(flow_result_array, self.tile_size_of)
