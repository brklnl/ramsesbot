...
with open(os.path.join(base_path,  'configs','main_test_config.json')) as f:
    config = json.load(f)
...
# Call the function
save_output(model, dataloader_validation, device, save_dir_validation, config)

# Assuming create_video is a predefined function
